...
exports.getEntries = {
    ...
    findByOwnerandUpdate: (id, body) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_experiencias_1.experienciasofDB.findOneAndUpdate({ owner: id }, body).exec();
    }),
    delete: (id) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_experiencias_1.experienciasofDB.findByIdAndDelete(id);
    }),
    findByOwnerandDelete: (id) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_experiencias_1.experienciasofDB.findOneAndDelete({ owner: id }).exec();
    })
};
